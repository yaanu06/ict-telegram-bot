...
const getContext = (overrides = {}) => {
    const context = {
        ...
        document: {
            ...
            querySelectorAll: () => [],
            querySelector: () => ({ dataset: { category: 'forex' } }),
            addEventListener: () => {}
        },
        console: { log: () => {}, error: () => {} },
        fetch: jest.fn().mockResolvedValue({ json: jest.fn().mockResolvedValue({}) }),
        setTimeout: () => 0,
        setInterval: () => 0,
        clearInterval: () => {},
...
describe.skip('rsi (Wilder smoothing)', () => {
    const context = getContext();
...
describe.skip('checkSniperEntry MSNR+TBS alternative path', () => {
    const context = getContext();
...
describe.skip('getPrecisionEntryCRT CE placement', () => {
    const context = getContext();
...
describe.skip('recomputeTradeLevels', () => {
    const context = getContext();
    const base = {
        direction: 'SELL',
...
describe.skip('Ghost Machine hard rules', () => {
    const context = getContext();
...
describe.skip('analyzeTimeframe Ghost Machine pattern matching', () => {
...
describe.skip('runAutoScan Ghost Machine timeframe handling', () => {
    const makeElements = () => {
...
describe.skip('checkHTFConfluenceAsync PARTIAL asymmetry', () => {
    const context = getContext();
...
describe.skip('checkZoneMagnetism primary-method zones', () => {
    const context = getContext();
...
describe.skip('OTE band orientation', () => {
    const context = getContext();
...
describe.skip('findPrecisionEntry zone side', () => {
    const context = getContext();
...
describe.skip('calcVolumeProfile', () => {
    const context = getContext();
...
describe.skip('checkSniperEntry', () => {
    const context = getContext();
...
describe.skip('validateAIResult', () => {
    const context = getContext();
...
describe.skip('getLiveCandleDirection', () => {
    let context;
